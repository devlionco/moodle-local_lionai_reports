...
$string['insertprompttemplate'] = 'הכנס תבנית בקשה';
$string['promptptemplate'] = '1. מה להחזיר (עמודות):
  - ציין אילו עמודות אתה רוצה לראות בטבלה, לדוגמה: שם מורה, שם קורס, מספר תלמידים.

2. מאיפה (מקורות/יישויות):
  - ציין את סוגי הנתונים או הישויות הרלוונטיות לדוח, לדוגמה: מורים, קורסים, תלמידים.

3. אילו סינונים או תנאים אתה רוצה להחיל (אופציונלי):
  - לדוגמה: רק קורסים פעילים, רק סמסטר מסוים, רק מורים עם יותר מ-20 תלמידים.';